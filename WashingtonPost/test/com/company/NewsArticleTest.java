...
public class NewsArticleTest {
    public static final String JSON_FOR_ONE_ARTICLE = "{\"author\":\"Leonard Shapiro, Mark Berman, Katie Zezima, Leonard Shapiro, Mark Berman, Katie Zezima\",\"title\":\"‘Once the storm starts, law enforcement cannot save you’: Fla. governor issues stern warning ahead of Irma\",\"description\":\"Although the storm's track has shifted west, it still remains a deadly threat to all of southern Florida.\",\"url\":\"https://www.washingtonpost.com/news/post-nation/wp/2017/09/08/hurricane-irma-churns-over-the-bahamas-on-collision-course-with-florida/\",\"urlToImage\":\"https://img.washingtonpost.com/pbox.php?url=http://img.washingtonpost.com/news/post-nation/wp-content/uploads/sites/23/2017/09/irma2.jpg&w=1484&op=resize&opt=1&filter=antialias&t=20170517\",\"publishedAt\":\"2017-09-09T15:00:00Z\"}";
        // firstly + "";
    public static final String JSON_FOR_ARRAY_ARTICLES = "[\n" +
                "{\n" +
    ...
    private NewsArticle newsArticle;   //use refactor to extract field
    private NewsArticle [] newsArticleArray;
    private ArrayList<NewsArticle> newsArticleArrayList = new ArrayList<NewsArticle>();

    @Before   //control + return to create setup method
    public void setUp() throws Exception {   //put those tranform in setup can reduce the workload
        Gson gson = new Gson();
        newsArticle = gson.fromJson(JSON_FOR_ONE_ARTICLE, NewsArticle.class);
        newsArticleArray = gson.fromJson(JSON_FOR_ARRAY_ARTICLES, NewsArticle[].class);//the first param is article; the second one is the thyle name.class


        for(int i = 0;i<newsArticleArray.length;i++){
            newsArticleArrayList.add(newsArticleArray[i]);  //why this cannot compile?
        }
    }
    ...
    public void getAuthor() throws Exception {
        ...
        assertEquals("Leonard Shapiro, Mark Berman, Katie Zezima, Leonard Shapiro, Mark Berman, Katie Zezima",newsArticle.getAuthor());
    }
    ...
    @Test
    public void getPublicshedAt() throws Exception {
    }
